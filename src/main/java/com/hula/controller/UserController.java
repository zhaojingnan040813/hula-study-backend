...
import com.hula.config.WxOpenConfig;
...
import com.hula.model.dto.user.UserLoginRequest;
import com.hula.model.dto.user.UserQueryRequest;
import com.hula.model.dto.user.UserRegisterRequest;
import com.hula.model.dto.user.UserUpdateMyRequest;
...
import static com.hula.service.impl.UserServiceImpl.SALT;
...
public class UserController {
    ...
    public BaseResponse<Boolean> addUserSignIn(HttpServletRequest request) {
        // 必须要登录才能签到
        User loginUser = userService.getLoginUser(request);//如果得不到的话，这里会抛异常的，就不会继续往下面走了
